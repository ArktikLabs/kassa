...
const id: MessageMap = {
  ...
  "receipt.id": "ID: {id}",
  "receipt.placeholder": "Tampilan struk 58mm/80mm diisi di ticket receipt berikutnya.",
  "admin.heading": "Admin",
...
const en: MessageMap = {
  ...
  "tender.cash.placeholder": "Keypad and change calculation arrive in the tender ticket.",
  "receipt.heading": "Receipt",
  "receipt.id": "ID: {id}",
  "receipt.placeholder": "58mm/80mm receipt layout arrives in the receipt ticket.",
  "admin.heading": "Admin",
