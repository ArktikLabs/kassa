...
const id: MessageMap = {
  ...
  "cart.charge.split": "Bayar campuran (tunai + QRIS)",
  ...
  "tender.split.heading": "Bayar Campuran",
  "tender.split.aria": "Bayar campuran tunai dan QRIS",
  "tender.split.total": "Total",
  "tender.split.cash": "Tunai",
  "tender.split.qris": "Sisa QRIS",
  "tender.split.cash.label": "Nominal tunai",
  "tender.split.cash.over":
    "Tunai melebihi total. Kurangi atau gunakan /tender/cash untuk bayar tunai penuh.",
  "tender.split.chip.half": "Setengah",
  "tender.split.chips.aria": "Nominal tunai cepat",
  "tender.split.keypad.aria": "Keypad nominal tunai",
  "tender.split.cart.empty": "Keranjang kosong. Kembali ke katalog untuk menambah barang.",
  "tender.split.submit.done": "Selesai",
  "tender.split.submit.submitting": "Menyimpan…",
  "tender.split.create.cta": "Buat QR untuk sisa",
  "tender.split.switch.cash": "Beralih ke pembayaran tunggal",
  "tender.split.error.finalize": "Gagal menyimpan transaksi campuran. Coba lagi.",
  "tender.split.error.amount_mismatch":
    "Jumlah QRIS yang diterima tidak cocok dengan sisa tagihan. Batalkan dan ulangi.",
  ...
  "receipt.tender.cash": "Tunai",
  "receipt.tender.qris": "QRIS",
  "receipt.tender.qris_static": "QRIS",
  "receipt.tender.card": "Kartu",
  "receipt.tender.other": "Lain",
...
const en: MessageMap = {
  ...
  "cart.charge.split": "Split payment (cash + QRIS)",
  "cart.row.qtyLine": "{quantity}× {unit}",
  ...
  "tender.split.heading": "Split payment",
  "tender.split.aria": "Pay with a mix of cash and QRIS",
  "tender.split.total": "Total",
  "tender.split.cash": "Cash",
  "tender.split.qris": "QRIS balance",
  "tender.split.cash.label": "Cash amount",
  "tender.split.cash.over":
    "Cash exceeds the bill. Lower it or switch to /tender/cash for a full cash sale.",
  "tender.split.chip.half": "Half",
  "tender.split.chips.aria": "Quick cash amounts",
  "tender.split.keypad.aria": "Cash amount keypad",
  "tender.split.cart.empty": "Cart is empty. Go back to the catalog to add items.",
  "tender.split.submit.done": "Done",
  "tender.split.submit.submitting": "Saving…",
  "tender.split.create.cta": "Generate QR for balance",
  "tender.split.switch.cash": "Switch to a single tender",
  "tender.split.error.finalize": "Could not save the split sale. Try again.",
  "tender.split.error.amount_mismatch":
    "QRIS amount paid does not match the remaining balance. Cancel and retry.",
  ...
  "receipt.tender.cash": "Cash",
  "receipt.tender.qris": "QRIS",
  "receipt.tender.qris_static": "QRIS",
  "receipt.tender.card": "Card",
  "receipt.tender.other": "Other",
